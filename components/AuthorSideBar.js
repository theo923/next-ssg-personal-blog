            ...
            <div className='mt-12 mx-6 mb-6 2xl:ml-3 mr-4 md:mr-6 xl:mr-8  shadow-xl'>
                <div className="max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
                    ...
                    <div className="px-6 py-4 ">
                        <h1 className="text-xl font-semibold text-gray-800 dark:text-white">Theo Tam</h1>

                        <p className="py-2 text-gray-700 dark:text-gray-400">Coder / Learner / Challenger</p>
                        
                        <div className="flex items-center mt-6 text-gray-700 dark:text-gray-200">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="#000000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5.52 19c.64-2.2 1.84-3 3.22-3h6.52c1.38 0 2.58.8 3.22 3"/><circle cx="12" cy="10" r="3"/><circle cx="12" cy="12" r="10"/></svg>
                            ...
                            <h1 className="px-2 text-sm">Full Stack React Developer</h1>
                        </div>
                        ...
                        <div className="flex items-center mt-6 text-gray-700 dark:text-gray-200">
                            ...
                            <h1 className="px-2 text-sm"><a className='text-blue-500 hover:text-blue-300' href='https://twitter.com/TheoTam4' target='_blank'>@TheoTam4</a></h1>
                        </div>
                        ...
                        <div className="flex items-center mt-6 text-gray-700 dark:text-gray-200">
                            ...
                            <h1 className="px-2 text-sm"><a className='text-blue-500 hover:text-blue-300' href='https://github.com/theo923' target='_blank'>@theo923</a></h1>
                        </div>
                        ...
                        <div className="flex items-center mt-6 text-gray-700 dark:text-gray-200">
                            ...
                            <h1 className="px-2 text-sm">theotam923@gmail.com</h1>
                        </div>
                        ...
                        <div className="flex items-center mt-6 text-gray-700 dark:text-gray-200">
                            ...
                            <h1 className="px-2 text-sm">London</h1>
                        </div>
