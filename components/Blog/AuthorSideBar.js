                ...
                <div className="px-6 py-4 ">
                    ...
                    <div className='font-hindSiliguri text-md'>
                        ...
                        <div className="flex items-center mt-6 text-gray-700">
                            ...
                            <h3 className="px-3"><a className='text-blue-500 hover:text-blue-300' href='https://twitter.com/TheoTam4' target='_blank'>@TheoTam4</a></h3>
                        </div>
                        ...
                        <div className="flex items-center mt-6 text-gray-700">
                            ...
                            <h3 className="px-3"><a className='text-blue-500 hover:text-blue-300' href='https://github.com/theo923' target='_blank'>@theo923</a></h3>
                        </div>
