            ...
            <div data-test="component-cover" ref={forwardRef} className='pb-20 lg:pb-20 mb-20 mx-4 lg:mx-20 min-h-screen'>
                <div className='flex flex-col items-center justify-center h-full m-11'>
                    ...
                    <SetIntersectionObserver type={3} direction='right'>
                        <p className='font-anaheim text-lg text-center mb-12 mx-9 xl:mx-40'>A React Developer based in UK with <span className=' p-0.5 bg-red-200'>0.5 years</span> of commercial experiences in freelancing, <span className=' p-0.5 bg-red-200'>4 years</span> of experiences in programming. Worked with <span className=' p-0.5 bg-red-200'>international startup</span> across hongkong and japan for building functional and complex online shopping application. Actively on Github <span className=' p-0.5 bg-red-200'>every day</span> with above <span className=' p-0.5 bg-red-200'>500+</span> contributions this year. Created more than <span className=' p-0.5 bg-red-200'>6+</span> projects within 4 months. Keep learning and writing Blog post <span className=' p-0.5 bg-red-200'>every day</span>.</p>
                    </SetIntersectionObserver>
