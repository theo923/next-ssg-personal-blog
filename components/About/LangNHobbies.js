            ...
            <div data-test="component-langNHobbies" ref={forwardRef} className='py-20 my-20 mx-4 lg:mx-14 min-h-screen'>
                <div className='grid grid-cols-2 text-center mb-12 lg:m-28'>
                    ...
                    <div className='border-r-2 border-gray-700 my-32'>
                        <SetIntersectionObserver type={1}  direction='down'><h3 className='font-spartan text-2xl lg:text-5xl mb-20'>LANGUAGES</h3></SetIntersectionObserver>
                    ...
                    <div className='border-l-2 border-gray-700 my-32'>
                        <SetIntersectionObserver type={1}  direction='down'><h3 className='font-spartan text-2xl lg:text-5xl mb-20'>HOBBIES</h3></SetIntersectionObserver>
