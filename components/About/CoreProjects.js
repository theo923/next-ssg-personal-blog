                            ...
                            <div className='grid grid-cols-1 lg:grid-cols-2'>
                                <div className='order-1 lg:order-1 mr-10 lg:mr-20'>
                                    ...
                                    <div className='font-anaheim gap-1'>
                                        ...
                                        {['Flexibility for using SSG & SSR', 'Superfast speed for SSG pages', 'SEO-efficient for SSR pages', 'Read .md files from post folder', 'Convert .md files into httpStrings', 'Store visitor\'s comments']
                                            .map((item, idx) => {
