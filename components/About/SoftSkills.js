...
const SoftSkills = ({ forwardRef }) => {
    ...
    return (
        <>
            <div data-test="component-softSkills" ref={forwardRef} className='py-20 my-20 mx-4 lg:mx-14 min-h-screen'>
                <div className='text-center mb-12 lg:m-28'>
                    <div className='border-gray-700'>
                        ...
                        <SetIntersectionObserver type={3} direction='left'><p className='font-anaheim text-xl mb-20'>- Communication</p></SetIntersectionObserver>
                        ...
                        <SetIntersectionObserver type={4} direction='left'><p className='font-anaheim text-xl mb-20'>- Organization</p></SetIntersectionObserver>
                        <SetIntersectionObserver type={5} direction='right'>
