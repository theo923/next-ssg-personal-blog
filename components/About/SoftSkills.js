        ...
        <div className="text-center mb-12 lg:m-28">
          <div className="border-gray-700">
            ...
            <SetIntersectionObserver type={4} direction="left">
              <p className="font-anaheim text-xl mb-20">- Teamwork</p>
            </SetIntersectionObserver>
            <SetIntersectionObserver type={5} direction="right">
              <p className="font-anaheim text-lg text-center mb-12 mx-9 xl:mx-40">
                ...
                practice. Sometimes, it is impossible to be familiar with
                everyone in the team, because of{" "}
                <span className=" p-0.5 bg-red-200">
                  different cultures and personalities
                </span>
                . In a football match, we are limited to have only 11 members to
                participate in a competition, which means some members cannot
                participate eventually. Sometimes, somebody may treat others as
                opponents. However, everyone in the team share the same goal -{" "}
                <span className=" p-0.5 bg-red-200">To Win the Match</span>,
                therefore, we can treat each other{" "}
                <span className=" p-0.5 bg-red-200">as a good competitor</span>{" "}
                -{" "}
                <span className=" p-0.5 bg-red-200">
            ...
            <SetIntersectionObserver type={3} direction="left">
              <p className="font-anaheim text-xl mb-20">- Communication</p>
            </SetIntersectionObserver>
            <SetIntersectionObserver type={4} direction="right">
              <p className="font-anaheim text-lg text-center mb-12 mx-9 xl:mx-40">
                In football match, every moves important, which may reverse the
                overall results in the end. Therefore, in order to work well in
                a team, teammates should{" "}
                <span className=" p-0.5 bg-red-200">
                ...
                . Each members should{" "}
                <span className=" p-0.5 bg-red-200">
                  understand and foresee other's action before they actually
                  move
                </span>
            ...
            <SetIntersectionObserver type={4} direction="left">
              <p className="font-anaheim text-xl mb-20">- Organization</p>
            </SetIntersectionObserver>
            <SetIntersectionObserver type={5} direction="right">
              <p className="font-anaheim text-lg text-center mb-12 mx-9 xl:mx-40">
                There are always conflict between Football Team practice and
                Self-learning. Everyday when we finished a football team
                practice we should feel tired and not willing to do anything, so
                homework and revisions are easily being ignored. Therefore,
