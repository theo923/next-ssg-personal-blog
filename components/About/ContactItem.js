            ...
            >
                <div className="flex flex-col justify-items-center items-center">
                    <SetIntersectionObserver type={1} direction="left">
                        <h3 className="font-spartan text-2xl lg:text-5xl mb-20 text-center mt-20">
                            Thank you for visiting my site
                        </h3>
                    </SetIntersectionObserver>
                    <SetIntersectionObserver type={2} direction="left">
                        <h3 className="font-spartan text-2xl lg:text-5xl mb-20 text-center">
                    ...
                    <SetIntersectionObserver type={5} direction="left">
                        <p className="font-anaheim text-2xl mb-20 text-center">
                            Telephone call is avaliable: +4407718602197
                        </p>
                    </SetIntersectionObserver>
                    <SetIntersectionObserver type={6} direction="left">
                        <button
                            className="font-anaheim flex justify-items-center items-center text-2xl mb-20 text-blue-400 hover:text-blue-800"
                            onClick={() => executeScroll(coreProjectsRef)}
                        >
                            <FaAngleDoubleRight className="mr-3 floatLeftRight" />
                            Go To The Top
                            <FaAngleDoubleLeft className="ml-3 floatRightLeft" />
                        </button>
                    </SetIntersectionObserver>
                    <SetIntersectionObserver type={7} direction="left">
                        <button className="font-anaheim flex justify-items-center items-center text-2xl mb-20 text-blue-400 hover:text-blue-800">
                            <FaAngleDoubleRight className="mr-3 floatLeftRight" />
