            ...
            {type === 'blog' ?
                <div>
                    <div id='header' className='flex items-center justify-center shadow-lg bg-gradient-to-r from-blue-500 to-blue-600' style={{height: 400}}>
                        <p className='m-4 text-2xl font-hindSiliguri text-white flex text-center'>Hello, I am Theo, Welcome to my blog.<br /> I love learning and I will keep sharing what I have learnt everyday.<br /> If you have questions/comments please leave a message on the Contact page</p>
                    </div>
