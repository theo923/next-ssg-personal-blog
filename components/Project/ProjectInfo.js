...
const ProjectInfo = () => {
            ...
            <div className="w-full p-6 mx-auto md:w-1/2 2xl:w-1/3">
                <a href={link} target="_blank">
                    <div className=" p-6 my-4 lg:p-8 cursor-pointer rounded-xl bg-gray-100 hover:bg-blue-200 shadow-2xl transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
                        <img
                            className="object-cover object-center h-72 w-full mb-8 rounded-xl"
                            src={imgUrl}
                            alt={heading}
                        />
                        <h2 className="font-spartan mx-auto mb-8 h-20 text-2xl font-semibold leading-normal tracking-tighter text-black title-font">
                            {heading}
                        </h2>
                        <p className=" font-hindSiliguri mx-auto text-lg leading-loose text-blueGray-700 h-64 ">
                            {context}
                        </p>
                    </div>
                </a>
    ...
    return (
        <section data-test="component-project" className="text-blueGray-700">
            <div className="container items-center px-5 py-64 mx-auto h-full lg:px-16">
                <div className="flex flex-wrap mb-12 text-left">
                    {ProjectGenerator(
                        "https://netfake.vercel.app/",
                        "./image/Netfake.png",
                        "Netfake - A Netflix main page Clone",
                    ...
                    {ProjectGenerator(
                        "https://hub.docker.com/u/theo9234/",
                        "./image/ShoppingMallDockerImage.png",
                        "React Shopping Mall Docker",
