...
const Footer = () => {
  return (
    <footer
      data-test="component-app-footer"
      className="flex flex-col items-center justify-between px-6 py-4 bg-white  sm:flex-row"
    >
      ...
      <p className="font-spartan italic text-lg py-2 text-gray-800 sm:py-0">
        All rights reserved
      </p>

      <div className="flex mx-2 gap-3">
        <a href="https://github.com/theo923" target="_blank">
          <FaGithub className="cursor-pointer hover:text-blue-500" size={20} />
        </a>
        ...
        <a href="https://twitter.com/TheoTam4" target="_blank">
          <FaTwitter className="cursor-pointer hover:text-blue-500" size={20} />
        </a>
